...
import { Enfant, ContactUrgence, GROUPE_AGE_LABELS } from '../types';
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* Parents */}
        <div className="card">
          <h2 className="mb-4">Parents / Tuteurs</h2>
              ...
              {enfant.parents?.map((ep) => (
                <div key={ep.parentId} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 capitalize">{ep.relation} {ep.estCustodial ? '• Gardien légal' : ''}</p>
                  </div>
