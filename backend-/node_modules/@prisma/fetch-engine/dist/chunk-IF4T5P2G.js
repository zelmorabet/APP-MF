...
var chunk_IF4T5P2G_exports = {};
__export(chunk_IF4T5P2G_exports, {
  cleanupCache: () => cleanupCache
});
module.exports = __toCommonJS(chunk_IF4T5P2G_exports);
...
async function cleanupCache(n = 5) {
  try {
    const rootCacheDir = await (0, import_chunk_D2GOUA3T.getRootCacheDir)();
    if (!rootCacheDir) {
