...
export default function LinkRadialDiagonal<Link, Node>({ className, children, data, innerRef, path, angle, radius, source, target, ...restProps }: AddSVGProps<LinkRadialDiagonalProps<Link, Node>, SVGPathElement>): import("react/jsx-runtime").JSX.Element;
export {};
