...
export default function GridRadial<Scale extends GridScale, Datum>({ arcThickness, className, endAngle, fill, fillOpacity, left, lineClassName, lineStyle, numTicks, scale, startAngle, stroke, strokeWidth, strokeDasharray, tickValues, top, ...restProps }: AllGridRadialProps<Scale, Datum>): import("react/jsx-runtime").JSX.Element;
