...
var chunk_6QTYANCE_exports = {};
__export(chunk_6QTYANCE_exports, {
  download: () => download,
...
module.exports = __toCommonJS(chunk_6QTYANCE_exports);
...
var import_chunk_HWBBHXY6 = require("./chunk-HWBBHXY6.js");
...
var import_temp_dir = (0, import_chunk_2ESYSVXG.__toESM)((0, import_chunk_HWBBHXY6.require_temp_dir)());
...
async function downloadBinary(options) {
  ...
  const { sha256, zippedSha256 } = await (0, import_chunk_HWBBHXY6.downloadZip)(downloadUrl, targetFilePath, progressCb);
  if (progressCb) {
    progressCb(1);
  }
