...
exports.ParentsModule = ParentsModule = __decorate([
    (0, common_1.Module)({ providers: [parents_service_1.ParentsService], controllers: [parents_controller_1.ParentsController], exports: [parents_service_1.ParentsService] })
], ParentsModule);
