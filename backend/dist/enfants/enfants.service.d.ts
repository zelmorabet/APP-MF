...
export declare class EnfantsService {
    private prisma;
    constructor(prisma: PrismaService);
    findAll(actifSeulement?: boolean): import(".prisma/client").Prisma.PrismaPromise<({
        contactUrgence: {
            id: string;
            prenom: string;
            nom: string;
    ...
    lierParent(enfantId: string, parentId: string, relation: string, estCustodial?: boolean): Promise<{
        enfantId: string;
        parentId: string;
        relation: string;
        estCustodial: boolean;
