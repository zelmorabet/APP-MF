...
export declare class RapportsService {
    ...
    rapportAssiduiteMensuel(mois: number, annee: number): Promise<{
        mois: number;
        annee: number;
        periode: string;
        lignes: {
    ...
    rapportFermetures(annee: number): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        dateDebut: Date;
    ...
    rapportFacturationAnnuelle(annee: number): Promise<{
        annee: number;
        factures: ({
            parent: {
                email: string;
    ...
    envoyerRapportBC(mois: number, annee: number, emailBC: string): Promise<{
        message: string;
    }>;
}
