...
export declare class EntentesController {
    private service;
    constructor(service: EntentesService);
    ...
    findByEnfant(id: string): import(".prisma/client").Prisma.PrismaPromise<({
        parent: {
            email: string;
            id: string;
            prenom: string;
    ...
    envoyerSignature(id: string): Promise<{
        email: string;
        id: string;
        createdAt: Date;
        updatedAt: Date;
